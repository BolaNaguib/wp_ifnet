            ...
            <div class="flex justify-between container mx-auto px-4">
                <div class="flex items-center">
                    <ul class="flex content-center">
                        <li>
                            <a aria-label="Facebook" href="https://www.facebook.com/pg/Yumyums.gallery/" class="text-gray-800 hover:text-black transition duration-300 ease-in-out px-2  block">
                        ...
                        <li>
                            <a aria-label="Instagram" href="https://www.instagram.com/yumyums.gallery/" class="text-gray-800 hover:text-black  transition duration-300 ease-in-out px-2  block">
                ...
                <div class="flex items-center">
                    <ul class="flex content-center">
                        ...
                        <li class="inline-block flex items-center text-gray-800">
